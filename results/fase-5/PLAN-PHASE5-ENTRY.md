...
user action** -- see `results/fase-5/PHASE-5-STATUS.md`.
...
`docs/fase-5.md` for the checklist.
...
- Capture `logcat`, `dmesg`, `getprop`, `last_kmsg`/`pstore`, services, in
  `results/fase-5/first-boot-runtime/`.
...
- Progressively fill the hardware matrix of `docs/fase-5.md`.
