...
**PHASE 6 IN PROGRESS -- plan: `results/fase-6/PHASE6-PLAN.md`.**
...
- **ROOT CAUSE of the hang (V35 diag): hwservicemanager CRASHES (SIGSEGV)** with a null-deref
  ...
  crash. It is the common root of the 4 symptoms. Detail: `fase-6/v35-system-live/DIAGNOSIS.md`.
...
the uboot logo remained. Detail: `results/fase-5/v33-system-live/DIAGNOSIS.md`.
...
Detail: `results/fase-5/v30-system-live/DIAGNOSIS.md`.
...
- **V23 (flashed, partial):** `user root` in `logd.rc`. Passed cap_set_proc and
  ...
  Detail: `results/fase-5/v23-system-live/DIAGNOSIS.md`.
...
tip of the iceberg. Full diagnosis: `results/fase-5/v21-system-live/DIAGNOSIS.md`.
...
system.img (full build). Detail: `results/fase-5/v21-system-live/DIAGNOSIS.md`.
...
- **Log capture (ESSENTIAL): see `results/fase-5/LOG-CAPTURE-METHOD.md`.**
...
`results/fase-5/v7-bootloop-recovery/last_kmsg.txt`. Full diagnosis:
`results/fase-5/v7-bootloop-recovery/DIAGNOSIS.md`.
...
Previous logs: `results/fase-5/v6-bootloop-recovery-last_kmsg.txt`,
`results/fase-5/v5-bootloop-recovery/last_kmsg.txt`.

### V8 (flashed, FAILED) and V9 (current candidate)

- **V8** (fstab in ramdisk) was flashed and **stayed in the loop**: same first-stage
  failure. `last_kmsg`: `results/fase-5/v8-bootloop-recovery/last_kmsg.txt`.
  Diagnosis and real root cause: `results/fase-5/v8-bootloop-recovery/DIAGNOSIS.md`.
...
- **V9 (current candidate)**: boot ramdisk from `TARGET_ROOT_OUT` (full legacy
  ...
  - Detail: `results/fase-5/PHASE5-V9-LEGACY-ROOTFS.md`.
...
`firmware/android/fstab` node. Detail: `results/fase-5/v9-bootloop-recovery/DIAGNOSIS.md`.
...
Detail: `results/fase-5/v10-bootloop-recovery/DIAGNOSIS.md`.
...
`results/fase-5/v12-hang-recovery/last_kmsg.txt` and `.../DIAGNOSIS.md`.
...
permissive. Detail: `results/fase-5/v11-bootloop-recovery/DIAGNOSIS.md`.
...
- Detail: `results/fase-5/PHASE5-V12-HARDCODED-FSTAB.md`.
...
- Detail: `results/fase-5/PHASE5-V11-FSTAB-FALLBACK.md`.
...
`results/fase-5/v13-hang-recovery/DIAGNOSIS.md`):
...
- Detail: `results/fase-5/PHASE5-V13-MULTIBINDER.md`.
...
`results/fase-5/v14-hang-recovery/DIAGNOSIS.md`):
...
- Detail: `results/fase-5/PHASE5-V15-DATA-RELEASE.md`.
...
- **Visibility wall:** the crash loop floods `ramoops`/`last_kmsg` and
  ...
  tombstones on disk. Detail: `results/fase-5/v15c-recovery/DIAGNOSIS.md`.
...
bionic. See `results/fase-5/v18-recovery/DIAGNOSIS.md`.
...
- Detail: `results/fase-5/PHASE5-V20-GRAPHICS-HIDL.md`.
...
`results/fase-5/v19-recovery/DIAGNOSIS.md`. Long effort, result not guaranteed.
...
hurdle (gralloc/EGL). Detail: `results/fase-5/PHASE5-V19-PTHREAD-SHIM.md`.
...
(system changes vs V5). See `results/fase-5/PHASE5-V18-*.md` and
`results/fase-5/v17-recovery/DIAGNOSIS.md`.
...
- Detail: `results/fase-5/PHASE5-V17-RO-HARDWARE.md` - root cause in
  `results/fase-5/v16-recovery/DIAGNOSIS.md`.
...
- Detail: `results/fase-5/PHASE5-V16-POSTFSDATA.md`.
...
- Detail/risk: `results/fase-5/PHASE5-V14-BINDER-SG.md`.
