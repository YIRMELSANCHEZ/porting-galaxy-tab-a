...
> step in `results/fase-5/HANDOFF-CURRENT-STATE.md`.** Per-version diagnoses in
> `results/fase-5/PHASE5-V8-FSTAB-IN-RAMDISK.md` and
> `results/fase-5/v7-bootloop-recovery/DIAGNOSIS.md`. The below is the 5.0/5.1/5.2
...
- Duration 54:19 with ccache. Log: `results/fase-5/build-full-rom.log`.
...
`results/fase-5/SYSTEM-BOOT-VERIFY.log`.
...
`results/fase-5/SYSTEM-PACKAGE.log`.
...
- Manifest: `results/fase-5/ARTIFACTS.sha256` (verified `OK`).

## 5.3 -- First boot (pending user)

Procedure and criteria in `results/fase-5/FIRST-BOOT-PROCEDURE.md`.
...
`results/fase-5/first-boot-runtime/` and classify the boot stage.
