...
failure. Per-version detail in `results/fase-4/RECOVERY-V*.md` and build/verify
logs in `sm-t280-phase4/packages/` (packages) and `results/fase-4/`
(images/logs).
...
- Runtime evidence: `results/fase-4/v21-runtime/` and `results/fase-4/RECOVERY-V21-HARDWARE-VERIFY.md`.
