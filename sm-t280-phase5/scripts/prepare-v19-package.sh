...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v19.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-pthread-shim-PHASE5-v19-DO-NOT-FLASH.tar.md5"
