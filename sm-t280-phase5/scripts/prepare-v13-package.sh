...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v13.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-multibinder-PHASE5-v13-DO-NOT-FLASH.tar.md5"
