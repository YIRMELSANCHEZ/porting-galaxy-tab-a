#!/usr/bin/env bash
# Phase 5 V25 - boot (V21 fstab+ffs) + system with composer@2.1-impl + allocator@2.0-impl (passthrough) for HWC1/gralloc0.
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v25.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-graphics-impl-PHASE5-v25-DO-NOT-FLASH.tar.md5"
