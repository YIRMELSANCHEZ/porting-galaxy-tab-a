...
converted="$workspace/results/fase-5/system-legacy-sparse-odin-v5.img"
...
tar --list --file "$package" | sed '/^$/d' > "$workspace/results/fase-5/LEGACY-SPARSE-SYSTEM-V5-TAR-CONTENTS.txt"
test "$(cat "$workspace/results/fase-5/LEGACY-SPARSE-SYSTEM-V5-TAR-CONTENTS.txt")" = $'boot.img\nsystem.img'
