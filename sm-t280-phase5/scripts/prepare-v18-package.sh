...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v18.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-ro-hardware-full-PHASE5-v18-DO-NOT-FLASH.tar.md5"
