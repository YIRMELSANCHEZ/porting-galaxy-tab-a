#!/usr/bin/env bash
# Phase 5 V31 - boot (V21 fstab+ffs) + system with BINDER_TYPE_FDA backport to the binder (kernel) -> pass HIDL buffer handles.
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v31.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-binder-fda-PHASE5-v31-DO-NOT-FLASH.tar.md5"
