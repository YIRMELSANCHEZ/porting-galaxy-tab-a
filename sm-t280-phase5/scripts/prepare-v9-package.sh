...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v9.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-legacy-rootfs-PHASE5-v9-DO-NOT-FLASH.tar.md5"
