...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v10.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-dt-fstab-PHASE5-v10-DO-NOT-FLASH.tar.md5"
