...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v11.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-fstab-fallback-PHASE5-v11-DO-NOT-FLASH.tar.md5"
