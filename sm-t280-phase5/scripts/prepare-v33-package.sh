#!/usr/bin/env bash
# Phase 5 V33 - boot (V21 fstab+ffs) + system with V29 ION-copy reverted: native framebuffer page-flip (no ion_invalidate).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v33.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-pageflip-PHASE5-v33-DO-NOT-FLASH.tar.md5"
