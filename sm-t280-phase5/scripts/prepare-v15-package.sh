...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v15.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-data-mount-PHASE5-v15-DO-NOT-FLASH.tar.md5"
