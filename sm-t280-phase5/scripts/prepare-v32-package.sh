#!/usr/bin/env bash
# Phase 5 V32 - boot (V21 fstab+ffs) + system with legacy usage bits 10/13/21 in libui (bootanim 0x400).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v32.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-gralloc-usage2-PHASE5-v32-DO-NOT-FLASH.tar.md5"
