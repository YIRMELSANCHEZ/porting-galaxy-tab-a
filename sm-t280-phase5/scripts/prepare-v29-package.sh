#!/usr/bin/env bash
# Phase 5 V29 - boot (V21 fstab+ffs) + system with gralloc HW_FB via ION copy (scx30g_v2) avoids exhausting the fb page-flip.
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v29.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-gralloc-fb-ion-PHASE5-v29-DO-NOT-FLASH.tar.md5"
