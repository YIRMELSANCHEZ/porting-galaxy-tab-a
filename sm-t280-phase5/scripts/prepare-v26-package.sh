#!/usr/bin/env bash
# Phase 5 V26 - boot (V21 fstab+ffs) + system with gralloc usage bit 0x2000000 (SPRD HWC) allowed in libui.
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v26.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-gralloc-usage-PHASE5-v26-DO-NOT-FLASH.tar.md5"
