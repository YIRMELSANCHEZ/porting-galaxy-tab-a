...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v17.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-ro-hardware-PHASE5-v17-DO-NOT-FLASH.tar.md5"
