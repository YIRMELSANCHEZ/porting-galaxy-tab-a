...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v20.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-graphics-hidl-PHASE5-v20-DO-NOT-FLASH.tar.md5"
