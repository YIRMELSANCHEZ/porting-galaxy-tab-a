#!/usr/bin/env bash
# Phase 5 V28 - boot (V21 fstab+ffs) + system with HWC2OnFbAdapter reading kernel fb0 dimensions (800x1280).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v28.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-fb-dims-PHASE5-v28-DO-NOT-FLASH.tar.md5"
