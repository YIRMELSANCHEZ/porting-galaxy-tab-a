#!/usr/bin/env bash
# Phase 5 V23 - boot (V21 fstab+ffs) + system with logd as root in logd.rc (drop_privs completes) -> logcat.
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v23.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-logd-root-PHASE5-v23-DO-NOT-FLASH.tar.md5"
