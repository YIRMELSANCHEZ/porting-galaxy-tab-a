#!/usr/bin/env bash
# Phase 5 V22 - boot (V21 fstab+ffs) + system with non-fatal logd caps (logcat).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v22.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-logd-caps-PHASE5-v22-DO-NOT-FLASH.tar.md5"
