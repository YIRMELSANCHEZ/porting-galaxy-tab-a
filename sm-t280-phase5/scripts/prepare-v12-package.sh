...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v12.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-hardcoded-fstab-PHASE5-v12-DO-NOT-FLASH.tar.md5"
