...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v21.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-adb-diag-PHASE5-v21-DO-NOT-FLASH.tar.md5"
