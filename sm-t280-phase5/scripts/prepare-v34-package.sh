#!/usr/bin/env bash
# Phase 5 V34 - boot (V21 fstab+ffs) + system with V29 ION + FBIOPAN after memcpy in fb_post (latch to the panel).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v34.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-fbpan-PHASE5-v34-DO-NOT-FLASH.tar.md5"
