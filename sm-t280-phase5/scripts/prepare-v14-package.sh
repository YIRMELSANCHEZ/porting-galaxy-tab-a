...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v14.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-binder-sg-PHASE5-v14-DO-NOT-FLASH.tar.md5"
