...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v8.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-fstab-in-ramdisk-PHASE5-v8-DO-NOT-FLASH.tar.md5"
