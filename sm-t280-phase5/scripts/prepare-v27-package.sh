#!/usr/bin/env bash
# Phase 5 V27 - boot (V21 fstab+ffs) + system with composer@2.1-impl forced to HWC2OnFbAdapter (avoids SPRD HWC).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v27.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-fb-adapter-PHASE5-v27-DO-NOT-FLASH.tar.md5"
