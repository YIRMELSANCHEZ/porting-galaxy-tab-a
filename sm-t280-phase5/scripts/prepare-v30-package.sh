#!/usr/bin/env bash
# Phase 5 V30 - boot (V21 fstab+ffs) + system with diagnostic: log of the result in gralloc + allocator passthrough.
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v30.img"
package="$workspace/sm-t280-phase5/packages/SM-T280-android10-alloc-diag-PHASE5-v30-DO-NOT-FLASH.tar.md5"
