...
Full detail and traceability in `results/fase-4/PHASE-4-STATUS.md` (v8-v21 consolidation section),
`results/fase-4/RECOVERY-V21-HARDWARE-VERIFY.md`, `sm-t280-phase4/docs/HANDOFF-PHASE4.md` and the manifest
`results/fase-4/ARTIFACTS.sha256`.
