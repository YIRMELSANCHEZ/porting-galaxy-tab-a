#!/usr/bin/env bash
# Phase 5 V35 - boot (V21 fstab+ffs) + system with ro.crypto.state=unencrypted + trigger nonencrypted (framework auto-boot).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v35.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-crypto-autoboot-PHASE6-v35-DO-NOT-FLASH.tar.md5"
