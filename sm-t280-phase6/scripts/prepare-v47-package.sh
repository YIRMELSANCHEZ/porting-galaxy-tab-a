...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v47.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-halcaps-PHASE6-v47-DO-NOT-FLASH.tar.md5"
