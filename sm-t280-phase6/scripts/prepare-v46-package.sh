...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v46.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-halroot-PHASE6-v46-DO-NOT-FLASH.tar.md5"
