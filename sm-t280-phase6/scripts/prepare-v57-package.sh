...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v57.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-powerkey-eic-PHASE6-v57-DO-NOT-FLASH.tar.md5"
