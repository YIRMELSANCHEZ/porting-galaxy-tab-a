...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v53.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-datadir-PHASE6-v53-DO-NOT-FLASH.tar.md5"
