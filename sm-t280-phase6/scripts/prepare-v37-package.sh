#!/usr/bin/env bash
# Phase 5 V37 - boot (V21 fstab+ffs) + system with device VINTF manifest (dalvik.vm.usejit=false, JIT SIGSEGV fix on kernel 3.10).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v37.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-nojit-PHASE6-v37-DO-NOT-FLASH.tar.md5"
