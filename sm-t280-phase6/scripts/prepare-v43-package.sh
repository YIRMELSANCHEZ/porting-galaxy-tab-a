...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v43.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-rotation180-PHASE6-v43-DO-NOT-FLASH.tar.md5"
