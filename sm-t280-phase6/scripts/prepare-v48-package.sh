...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v48.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-eexist-PHASE6-v48-DO-NOT-FLASH.tar.md5"
