...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v50.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-modpath-PHASE6-v50-DO-NOT-FLASH.tar.md5"
