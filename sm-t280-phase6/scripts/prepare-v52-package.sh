...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v52.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-wpapath-PHASE6-v52-DO-NOT-FLASH.tar.md5"
