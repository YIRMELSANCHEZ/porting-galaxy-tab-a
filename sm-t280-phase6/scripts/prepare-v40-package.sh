#!/usr/bin/env bash
# Phase 5 V40 - boot (V21 fstab+ffs) + system with device VINTF manifest (xi:include audio policy, AudioPolicyManager fix).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v40.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-audio-policy-PHASE6-v40-DO-NOT-FLASH.tar.md5"
