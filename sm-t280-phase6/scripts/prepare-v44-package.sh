...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v44.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-driver-PHASE6-v44-DO-NOT-FLASH.tar.md5"
