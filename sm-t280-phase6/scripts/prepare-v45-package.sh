...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v45.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-supplicant-PHASE6-v45-DO-NOT-FLASH.tar.md5"
