...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v56.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-powerkey-PHASE6-v56-DO-NOT-FLASH.tar.md5"
