#!/usr/bin/env bash
# Phase 5 V41 - boot (V21 fstab+ffs) + system with device VINTF manifest (keymaster TEE-soft, keystore/boot_completed fix).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v41.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-keymaster-PHASE6-v41-DO-NOT-FLASH.tar.md5"
