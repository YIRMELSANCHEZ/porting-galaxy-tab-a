#!/usr/bin/env bash
# Phase 5 V36 - boot (V21 fstab+ffs) + system with device VINTF manifest (hwservicemanager crash fix).
...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v36.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-vintf-manifest-PHASE6-v36-DO-NOT-FLASH.tar.md5"
