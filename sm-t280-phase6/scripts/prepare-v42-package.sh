...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v42.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-ion-legacy-PHASE6-v42-DO-NOT-FLASH.tar.md5"
