...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v49.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-legacyhal-PHASE6-v49-DO-NOT-FLASH.tar.md5"
