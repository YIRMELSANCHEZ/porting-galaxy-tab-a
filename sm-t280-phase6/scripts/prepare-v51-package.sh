...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v51.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-wifi-generichal-PHASE6-v51-DO-NOT-FLASH.tar.md5"
