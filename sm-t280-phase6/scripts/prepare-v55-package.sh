...
converted="$workspace/results/phase-5/system-legacy-sparse-odin-v55.img"
package="$workspace/sm-t280-phase6/packages/SM-T280-android10-usability-PHASE6-v55-DO-NOT-FLASH.tar.md5"
